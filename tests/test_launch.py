...
def test_launch_file():
    with (
        patch(f"{typer.__name__}._click._termui_impl.sys.platform", "win32"),
        patch(f"{typer.__name__}._click._termui_impl.WIN", True),
        patch(f"{typer.__name__}._click._termui_impl.CYGWIN", False),
