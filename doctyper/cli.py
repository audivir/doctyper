...
def get_typer_from_module(module: Any) -> doctyper.Typer | None:
...
def get_typer_from_state() -> doctyper.Typer | None:
    spec = None
    if state.file:
...
def docs(
    ...
    output: Path | None = doctyper.Option(
        None,
        help="An output file to write docs to, like README.md.",
        file_okay=True,
        dir_okay=False,
    ),
    title: str | None = doctyper.Option(
        None,
